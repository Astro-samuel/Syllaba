// Mirrors the shapes in ../../src/types/index.ts (and ../../mcp-server/src/types.ts).
// Duplicated rather than imported because this runs in the Cloudflare
// Workers runtime with its own build (wrangler), not bundled with the Vite
// app or the local mcp-server package — only the fields this server
